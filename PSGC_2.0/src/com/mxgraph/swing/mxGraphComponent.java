...
public class mxGraphComponent extends JScrollPane implements Printable
{
	 ...
	 * it is the zoom size of editor/ page
	 */
	public static final double DEFAULT_PAGESCALE = 0.7;

	/**
	 * Loads the collapse and expand icons.
	 * I find no options like expand, collapsed or warning
	 */
	static
	{
	 ...
	 */
	protected Color pageBreakColor = Color.black; // darkGray
	 ...
	 * 
	 */
	protected Color gridColor = Color.darkGray; // new Color(192, 192, 192)
	 ...
	 */
	protected int zoomPolicy = ZOOM_POLICY_PAGE; // ZOOM_POLICY_WIDTH
	 ...
	 */
	public boolean showDirtyRectangle = false; // false
