...
public class EditorToolBar extends JToolBar
{
	...
	public EditorToolBar(final BasicGraphEditor editor, int orientation)
	{
		...
		add(editor.bind("Run Analysis", new EditorActions.RunAction(),
				"/com/mxgraph/examples/swing/images/triangle.png"));
		add(editor.bind("View Graph", new EditorActions.DiagramAction(),
				"/com/mxgraph/examples/swing/images/barchart.png"));
